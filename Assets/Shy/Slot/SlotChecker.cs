...
public static class SlotChecker
{
    ...
    public static Item[] GetSOCheck(ItemSO _so, bool _oneTimeCheck)
    {
    ...
    public static Item[] GetCategoryCheck(ItemCategory _category, bool _oneTimeCheck)
    {
    ...
    public static void GetSlotsToRange(List<Item[]> _slot, SlotRange _range, Vector2Int _pos, bool _includeSelf)
    {
        result.Clear();
